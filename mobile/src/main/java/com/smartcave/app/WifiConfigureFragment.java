 ...
 * {@link WifiConfigureFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link WifiConfigureFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class WifiConfigureFragment extends BaseFragment {
...
//                mArrayAdapter.add(device.getName() + "\n" + device.getAddress());
    ...
    public static WifiConfigureFragment newInstance(String param1, String param2) {
        WifiConfigureFragment fragment = new WifiConfigureFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.fragment_wifi_configure);
    }
...
// Register the BroadcastReceiver
    ...
    private void setup() {
        mIpView = (EditText) this.findViewById(R.id.text_ip);
        ...
        mPairButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(ip)){
                    mIpView.setError("Required");
                    mIpView.requestFocus();
                    return;
                }
                PrefUtil.getInstance(getContext()).setConnectedIp(ip);
